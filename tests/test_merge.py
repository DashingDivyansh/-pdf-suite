...
class MergeTests(unittest.TestCase):
    def test_merge_fails_if_less_than_two_files_provided(self):
        self.assertEqual(
    ...
    def test_merge_reports_error_when_input_file_is_missing(self, _val_files, _val_out):
    ...
    def test_merge_correctly_constructs_qpdf_command_arguments(self, run_command, _val_files, _val_out, _makedirs):
    ...
    @patch("core.merge.validate_pdf_files", return_value=None)
    @patch("core.merge.run_command", return_value="SUCCESS")
    def test_merge_applies_specified_page_ranges_to_command(self, run_command, _val_files, _val_out, _makedirs):
    ...
    @patch("core.merge.validate_pdf_files", return_value=None)
    def test_merge_prevents_overwriting_input_files(self, _val_files, _val_out):
